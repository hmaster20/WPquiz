...
function co_dashboard_page() {
    ...
    <div class="wrap">
        ...
        <div class="co-statistics-container" style="display: none;">
            <!-- Подраздел Обзор -->
            <h3><?php _e('Overview', 'career-orientation'); ?></h3>
            <div class="co-overview-section">
                <h4><?php _e('Описание плагина', 'career-orientation'); ?></h4>
                ...
                <h4><?php _e('Как работать с плагином', 'career-orientation'); ?></h4>
                <ul>
                ...
                <h4><?php _e('Как использовать шорткод', 'career-orientation'); ?></h4>
                ...
                <h4><?php _e('Пример', 'career-orientation'); ?></h4>
                ...
                <h4><?php _e('Разделы', 'career-orientation'); ?></h4>
                <ul>
