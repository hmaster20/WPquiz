...
Cyrlitera - URL страниц латиницей

Основной цвет: #363636

---

Добавить в Reports:
Агрегацию отчетов в нескольких разрезах:

- по датам
  по годам (главное меню)
  Сортировка по месяцам
  Внутри месяца отображаем дни и и время фактически выполненных тестов

- по клиентам
  За основу берем ФИО

Нужно извлечь стили из всех файлов и обеспечить использование единого файла стилей.
